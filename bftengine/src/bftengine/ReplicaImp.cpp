...
ReplicaImp::ReplicaImp(bool firstTime,
    ...
    : ReplicaForStateTransfer(config, requestsHandler, stateTrans, msgsCommunicator, msgHandlers, firstTime, timers),
      ...
      hanan_consensus_duration_{metrics_, "hanan_consensus_duration__", 1000, true},
      hanan_post_exe_duration_{metrics_, "hanan_post_exe_duration__", 1000, true},
      hanan_primary_batching_duration_{metrics_, "hanan_primary_batching_duration__", 10000, true},
